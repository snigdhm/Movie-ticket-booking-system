...
public class mani extends JFrame {
	 ...
	 * Create the frame.
	 */
	public mani(int f,String s,final int dis) {
		final int flag=f;
		final String name=s;
	...
	if(flag==0)
	{
		...
		JLabel lblNewLabel = new JLabel("");
		 Image img1_4 = new ImageIcon(this.getClass().getResource("/mani11.jpg")).getImage();
		 lblNewLabel.setIcon(new ImageIcon(img1_4));
		lblNewLabel.setBounds(186, 461, 150, 150);
		contentPane.add(lblNewLabel);
		 Image img1_5 = new ImageIcon(this.getClass().getResource("/mani21.jpg")).getImage();
		
		JLabel lblNewLabel_2 = new JLabel("");
		 Image img1_6 = new ImageIcon(this.getClass().getResource("/mani31.jpg")).getImage();
		 lblNewLabel_2.setIcon(new ImageIcon(img1_6));
		lblNewLabel_2.setBounds(735, 206, 150, 150);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		 Image img1_7 = new ImageIcon(this.getClass().getResource("/mani41.jpg")).getImage();
		 lblNewLabel_3.setIcon(new ImageIcon(img1_7));
		lblNewLabel_3.setBounds(186, 206, 150, 150);
		contentPane.add(lblNewLabel_3);
		 Image img1_8 = new ImageIcon(this.getClass().getResource("/mani51.jpg")).getImage();
		
		JLabel lblNewLabel_5 = new JLabel();
		 Image img1_9 = new ImageIcon(this.getClass().getResource("/mani61.jpg")).getImage();
		...
		mov2="SPECTRE\n\nDiana Theatre\nSH 37, Bhagyamandira Municipal Colony\nChitpady\nManipal - 576101\nRating:4/5";
		mov3="MINIONS\n\nCinepolis\nCentral Mall\n3rd Floor\nMG Road, Manipal - 570045\nRating: 3.5/5";
		mov4="AIRLIFT\n\nInox Cinemas\n1st Floor, Central Cinemas\nLaxmindra Nagar\nUdupi Main Road, Manipal - 576104\nRating:5/5";
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("PIKU",name,dis,mov1);
				b.setVisible(true);}
				//b.bookee("PIKU");
			}
		});
		...
		btnBook_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("SPECTRE",name,dis,mov2);
				/*b.bookee("SPECTRE");*/
				b.setVisible(true);}
			}
		});
		...
		btnBook_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("AIRLIFT",name,dis,mov4);
				/*b.bookee("AIRLIFT");*/
				b.setVisible(true);}
			}
		});
		...
		btnBook_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				/*login_back l=new login_back();,dis
				l.login();*/
				if(flag==0)
				{
					login_back l=new login_back();
				...
				book b=new book("MINIONS",name,dis,mov3);
				//b.bookee("MINIONS");
				b.setVisible(true);}
			}
		});
