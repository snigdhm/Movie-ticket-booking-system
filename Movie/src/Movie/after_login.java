...
/*	public int[] flag=new int[40];*/
	...
	public after_login(String n) {
		...
		JButton btnNewButton_8 = new JButton("YOUR BOOKINGS");
		btnNewButton_8.setFont(new Font("DejaVu Serif", Font.ITALIC, 14));
		btnNewButton_8.setBackground(Color.DARK_GRAY);
		btnNewButton_8.setForeground(Color.WHITE);
		btnNewButton_8.setBounds(402, 0, 170, 34);
		...
		btnNewButton_8.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					...
					yourbookings y =new yourbookings(s);
					y.setVisible(true);
			}
		});
	 ...
	 */
	public after_login(final int f,String n,int d) {
		final int z=d;
		//super("MOVIE SLIDE SHOW");
		final String s;
		s=n;
