...
public class hubli extends JFrame {
	 ...
	 */
	public static void hubli1() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					/*hubli frame = new hubli();
	 ...
	 * Create the frame.
	 */
	public hubli(int f,String s,final int dis) {
		final int flag=f;
		final String name=s;
	...
	if(flag==0)
	{
		...
		JLabel lblNewLabel = new JLabel("");
		 Image img1_4 = new ImageIcon(this.getClass().getResource("/hubli11.jpg")).getImage();
		 lblNewLabel.setIcon(new ImageIcon(img1_4));
		lblNewLabel.setBounds(186, 461, 150, 150);
		contentPane.add(lblNewLabel);
		 Image img1_5 = new ImageIcon(this.getClass().getResource("/hubli21.jpg")).getImage();
		
		JLabel lblNewLabel_2 = new JLabel("");
		 Image img1_6 = new ImageIcon(this.getClass().getResource("/hubli31.jpg")).getImage();
		 lblNewLabel_2.setIcon(new ImageIcon(img1_6));
		lblNewLabel_2.setBounds(735, 206, 150, 150);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		 Image img1_7 = new ImageIcon(this.getClass().getResource("/hubli41.jpg")).getImage();
		 lblNewLabel_3.setIcon(new ImageIcon(img1_7));
		lblNewLabel_3.setBounds(186, 206, 150, 150);
		contentPane.add(lblNewLabel_3);
		 Image img1_8 = new ImageIcon(this.getClass().getResource("/hubli51.jpg")).getImage();
		
		JLabel lblNewLabel_5 = new JLabel();
		 Image img1_9 = new ImageIcon(this.getClass().getResource("/hubli61.jpg")).getImage();
		 lblNewLabel_5.setIcon(new ImageIcon(img1_9));
		lblNewLabel_5.setBounds(756, 448, 150, 150);
		contentPane.add(lblNewLabel_5);
		final String mov1,mov2,mov3,mov4;
		mov1="3 IDIOTS\n\nApsara Theaters\nCoen Rd, Hubli - 580020\nRating: 3.5/5";
		mov2="LOAFER\n\nCinepolis\nCTS No. 4784/B, 3rd Floor\nUrban Oasis Mall, Gokul Road\nHubli - 580030\nRating: 5/5";
		mov3="DEADPOOL\n\nSree Padma Theatre\nAdjacent to Koppikar Road\nVictoria Rd, Kamaripeth\nNew Hubli, Hubli - 580020\nRating: 3.5/5";
		mov4="BARFI!\n\nRupam Talkies\nStation Road, Opposite Prakash Hotel\nStation Road, Hubli - 580020\nRating: 3.5/5";
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("3IDIOTS",name,dis,mov1);
				b.setVisible(true);}
			}
		});
		...
		btnBook_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("LOAFER",name,dis,mov4);
				b.setVisible(true);}
			}
		});
		...
		btnBook_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("BARFI",name,dis,mov3);
				b.setVisible(true);}
			}
		});
		...
		btnBook_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("DEADPOOL",name,dis,mov2);
				b.setVisible(true);}
			}
		});
