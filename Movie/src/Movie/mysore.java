...
public class mysore extends JFrame {
	 ...
	 */
	public static void mysore1() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					/*mysore frame = new mysore();
	 ...
	 * Create the frame.
	 */
	public mysore(int f,String s ,final int dis){
		final int flag=f;
		final String name=s;
	...
	if(flag==0)
	{
		...
		JLabel lblNewLabel = new JLabel("");
		 Image img1_4 = new ImageIcon(this.getClass().getResource("/mysore11.jpg")).getImage();
		 lblNewLabel.setIcon(new ImageIcon(img1_4));
		lblNewLabel.setBounds(186, 461, 150, 150);
		contentPane.add(lblNewLabel);
		 Image img1_5 = new ImageIcon(this.getClass().getResource("/mysore21.jpg")).getImage();
		
		JLabel lblNewLabel_2 = new JLabel("");
		 Image img1_6 = new ImageIcon(this.getClass().getResource("/mysore31.jpg")).getImage();
		 lblNewLabel_2.setIcon(new ImageIcon(img1_6));
		lblNewLabel_2.setBounds(735, 206, 150, 150);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		 Image img1_7 = new ImageIcon(this.getClass().getResource("/mysore41.jpg")).getImage();
		 lblNewLabel_3.setIcon(new ImageIcon(img1_7));
		lblNewLabel_3.setBounds(186, 206, 150, 150);
		contentPane.add(lblNewLabel_3);
		 Image img1_8 = new ImageIcon(this.getClass().getResource("/mysore51.jpg")).getImage();
		
		JLabel lblNewLabel_5 = new JLabel();
		 Image img1_9 = new ImageIcon(this.getClass().getResource("/mysore61.jpg")).getImage();
		 lblNewLabel_5.setIcon(new ImageIcon(img1_9));
		lblNewLabel_5.setBounds(756, 448, 150, 150);
		contentPane.add(lblNewLabel_5);
		
		final String mov1,mov2,mov3,mov4;
		mov1="INSIDE OUT\n\nInox Theater\nPlot No. C1, Third Floor\nMall of Mysore, MG Road\nIndira Nagar Extension\nNazarbad Mohalla, Mysore - 570010\nRating: 3/5";
	    mov2="ROUGH\n\nDRC Cinemas\n3rd Floor, B.M.Habitat Mall\nGokulam Main Road\nJayalakshmipuram, Mysore - 570012\nRating: 3/5";
		mov3="THE MARTIAN\n\nSaraswathi Theatre\nNew Kantharaj Urs Rd\n1st Main, Near HDFC Bank\nSaraswathipuram, Mysore - 570009\nRating: 4.5/5";
		mov4="REVOLVER RANI\n\nSterling Skyline Theatre\n4th Main 19th Cross Rd\nVidayaranya Puram, Mysore - 570008\nRating: 4/5";
		JTextArea textArea = new JTextArea(mov1);
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("INSIDE OUT",name,dis,mov1);
				b.setVisible(true);}
			}
		});
		...
		btnBook_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("ROUGH",name,dis,mov2);
				b.setVisible(true);}
			}
		});
		...
		btnBook_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("REVOLVER RANI",name,dis,mov4);
				b.setVisible(true);}
			}
		});
		...
		btnBook_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("THE MARTAIAN",name,dis,mov3);
				b.setVisible(true);}
			}
		});
