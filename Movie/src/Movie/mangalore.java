...
public class mangalore extends JFrame {
	 ...
	 * Create the frame.
	 */
	public mangalore(int f,String s,final int dis) {
		final int flag=f;
		final String name=s;
	...
	if(flag==0)
	{
		...
		JLabel lblNewLabel = new JLabel("");
		 Image img1_4 = new ImageIcon(this.getClass().getResource("/mangalore11.jpg")).getImage();
		 lblNewLabel.setIcon(new ImageIcon(img1_4));
		lblNewLabel.setBounds(186, 461, 150, 150);
		contentPane.add(lblNewLabel);
		 Image img1_5 = new ImageIcon(this.getClass().getResource("/mangalore21.jpg")).getImage();
		
		JLabel lblNewLabel_2 = new JLabel("");
		 Image img1_6 = new ImageIcon(this.getClass().getResource("/mangalore31.jpg")).getImage();
		 lblNewLabel_2.setIcon(new ImageIcon(img1_6));
		lblNewLabel_2.setBounds(735, 206, 150, 150);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		 Image img1_7 = new ImageIcon(this.getClass().getResource("/mangalore41.jpg")).getImage();
		 lblNewLabel_3.setIcon(new ImageIcon(img1_7));
		lblNewLabel_3.setBounds(186, 206, 150, 150);
		contentPane.add(lblNewLabel_3);
		 Image img1_8 = new ImageIcon(this.getClass().getResource("/mangalore51.jpg")).getImage();
		
		JLabel lblNewLabel_5 = new JLabel();
		 Image img1_9 = new ImageIcon(this.getClass().getResource("/mangalore61.jpg")).getImage();
		 lblNewLabel_5.setIcon(new ImageIcon(img1_9));
		lblNewLabel_5.setBounds(756, 448, 150, 150);
		contentPane.add(lblNewLabel_5);
		final String mov1,mov2,mov3,mov4;
		mov1="THE MARTIAN\n\nPVR CinemasCity Center Mall , 4th Floor\nK.S. Rao Road, Hampankatta\nMangalore - 575001\nRating: 4.5/5";
		mov2="HERO\n\nJyoti Theaters\nNear Gandhi Park, State Bank\nMangaluru - 575001\nRating: 2.5/5";
		mov3="MASTERPIECE\n\nPVR Cinemas\nForum Fiza Mall, Pandeshwar\n Mangalore - 575001\nRating: 5/5";
		mov4="PULI\n\nBig Cinemas\nBharat Mall, Opp. KSRTC\nBejai, Mangalore - 575004\nRating: 3/5";
		JTextArea txtrSdsf = new JTextArea(mov4);
		...
		JTextArea textArea_3 = new JTextArea(mov1);
		...
		JTextArea textArea_1 = new JTextArea(mov2);
		...
		JTextArea textArea_2 = new JTextArea(mov3);
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("PULI",name,dis,mov4);
				b.setVisible(true);}
			}
		});
		...
		btnBook_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("THE MARTIAN",name,dis,mov1);
				b.setVisible(true);}
			}
		});
		...
		btnBook_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("HERO",name,dis,mov2);
				b.setVisible(true);}
			}
		});
		...
		btnBook_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("MASTERPIECE",name,dis,mov3);
				b.setVisible(true);}
			}
		});
