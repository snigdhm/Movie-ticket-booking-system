...
public class coorg extends JFrame {
	 ...
	 */
	public static void coorg1() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					/*coorg frame = new coorg();
	 ...
	 * Create the frame.
	 */
	public coorg(int f,String s,final int dis) {
		final int flag=f;
		final String name=s;
	...
	if(flag==0)
	{
		...
		JLabel lblNewLabel = new JLabel("");
		 Image img1_4 = new ImageIcon(this.getClass().getResource("/coorg11.jpg")).getImage();
		 lblNewLabel.setIcon(new ImageIcon(img1_4));
		lblNewLabel.setBounds(186, 461, 150, 150);
		contentPane.add(lblNewLabel);
		 Image img1_5 = new ImageIcon(this.getClass().getResource("/coorg21.jpg")).getImage();
		
		JLabel lblNewLabel_2 = new JLabel("");
		 Image img1_6 = new ImageIcon(this.getClass().getResource("/coorg31.jpg")).getImage();
		 lblNewLabel_2.setIcon(new ImageIcon(img1_6));
		lblNewLabel_2.setBounds(735, 206, 150, 150);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		 Image img1_7 = new ImageIcon(this.getClass().getResource("/coorg41.jpg")).getImage();
		 lblNewLabel_3.setIcon(new ImageIcon(img1_7));
		lblNewLabel_3.setBounds(186, 206, 150, 150);
		contentPane.add(lblNewLabel_3);
		 Image img1_8 = new ImageIcon(this.getClass().getResource("/coorg61.jpg")).getImage();
		
		JLabel lblNewLabel_5 = new JLabel();
		 Image img1_9 = new ImageIcon(this.getClass().getResource("/coorg51.jpg")).getImage();
		 lblNewLabel_5.setIcon(new ImageIcon(img1_9));
		lblNewLabel_5.setBounds(756, 448, 150, 150);
		contentPane.add(lblNewLabel_5);
		
		final String mov1,mov2,mov3,mov4;
		mov1="RAMAIYA VASTAVAIYA\n\nIMAX Theater\nMahadeswara Complex\nMG Road, Coorg - 571221\nRating: 5/5";
		mov2="ASSASSIN\n\nCauvery Mahal Center\nJunior College Road\nMadikeri, Coorg - 571201\nRating: 4/5";
		mov3="BHAAG MILKHA BHAAG\n\nCoorg Cineplex\nBM Road, Baichanahalli\nKushalnagar, Coorg - 571234\nRating: 3.5/5";
		mov4="PK\n\nPVR Cinemas\nCentral Mall, Jyoti Juntion\nCoorg - 571220\nRating: 4.5/5";
		...
		btnBook.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("RAMAIAH VASTAVAYA",name,dis,mov1);
				b.setVisible(true);}
			}
		});
		...
		btnBook_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("ASSASSIN",name,dis,mov2);
				b.setVisible(true);}
			}
		});
		...
		btnBook_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("PK",name,dis,mov4);
		...
		btnBook_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				book b=new book("BHAAG MILKA BHAAG",name,dis,mov3);
				b.setVisible(true);}
			}
		});
